...
""" 
    ...
    print(Fore.RED + f" CONTACT US: ⨭ {Fore.GREEN}https://t.me/doctor_amk")
    ...
    print(Fore.YELLOW + f" PARTNER CHANNEL  {Fore.GREEN}https://https://t.me/Airdrophack1239")
    print(Fore.YELLOW + f" PASTE YOUR (QUERY ID) INTO QUERY.TXT FILE AND PRESS START ")
    log_line()
